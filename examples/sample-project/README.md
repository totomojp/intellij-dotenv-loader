# Dotenv Loader プラグイン - 動作確認サンプル

Dotenv Loader プラグインの動作を確認するためのサンプルプロジェクトです。

## 前提条件

- IntelliJ IDEA（Java モジュール付き）
...
### 2. このプロジェクトを IntelliJ で開く

`File > Open` でこの `sample-project/` ディレクトリを開きます。
...
`src/main/kotlin/com/example/sample/Main.kt` を開き、
`main` 関数の左の ▶ をクリックして実行。

## 期待される出力

**プラグイン有効時:**
```
=== Dotenv Loader Plugin - 動作確認サンプル ===

--- 環境変数の読み込み結果 ---
  [OK] APP_NAME = Dotenv Sample App
